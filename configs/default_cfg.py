...
_C.DATASET.NAME = ""
# which fold to use, default is 0 of 5 folds
_C.DATASET.FOLD = 0
...
_C.OPTIM.ADAM_EPS = 1e-8   # need to be set to 1e-3 in fp16 training
...
# Hematoma Expansion resnet3d
_C.MODEL.BACKBONE.IN_CHANNELS = 1
_C.MODEL.BACKBONE.STRIDES = ()
_C.MODEL.HEAD.OUT_CHANNELS = 1
_C.MODEL.BACKBONE.ACT = "relu"
_C.MODEL.BACKBONE.INPLANE_RATIO = 1.0
_C.MODEL.BACKBONE.LAYERS = (1, 1, 1, 1)